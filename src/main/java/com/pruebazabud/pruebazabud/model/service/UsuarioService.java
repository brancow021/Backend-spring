...
import com.pruebazabud.pruebazabud.model.dao.iUsuarioDao;
...
public class UsuarioService implements UserDetailsService {
    ...
    public UserDetails loadUserByUsername(String username) throws UsernameNotFoundException {
        ...
        List<GrantedAuthority> authorities = usuario.getRoles() //SE CONVIERTE EL STRING AL TIPO DE DATOS SIMPLEGRANDED
                .stream()
